...
@property (weak, nonatomic) IBOutlet UIView *vwParalax;
...
//    self.vwParalax = [ParallaxHeaderView parallaxHeaderViewWithImage:[UIImage imageNamed:@"HeaderImage"] forSize:CGSizeMake(self.mainTableView.frame.size.width, 300)];
//    [self.vwParalax reloadInputViews];
